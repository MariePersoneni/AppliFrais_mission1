...
class PdoGsb
{
    ...
    /**
     * Retourne les informations d'un visiteur ou d'un comptable selon la table envoy�e en param�tre
     * 
     * @param String $table     table dans laquelle les infos sont r�cup�r�es
     * @param String $login     Login de l'utilisateur
     * @param String $mdp       Mot de passe de l'utilisateur
     * 
     * @return l'id, le nom et le prénom sous la forme d'un tableau associatif

...
class PdoGsb
{
    ...
    /**
     * Fonction utilis�e une seule fois suite au changement de 
     * structure de la base de donn�es pour la gestion des 
     * frais kilom�trique.
     * La fonction parcours les fiches de frais et insert
     * des lignes de frais kilom�trique la ou il en manque.
     */
    public function insertFraisKmPrecedentesFiches()
    {
        //r�cup�ration de toutes les fiches
        $requetePrepare = PdoGsb::$monPdo->prepare(
        ...
        // r�cup�ration des id frais km
        $lesIdFraisKm = $this->getLesIdFraisKm(); 
        // parcours des fiches
            foreach ($lesFiches as $uneFiche){
                //r�cup�re les lignes de frais km
